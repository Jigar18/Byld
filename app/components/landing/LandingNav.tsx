...
export default function LandingNav() {
  ...
  return (
    <header className="fixed inset-x-0 top-4 z-50 px-3 sm:top-5 sm:px-5">
      <nav className="mx-auto h-16 max-w-[1120px] rounded-full border border-white/[0.1] bg-[#0c0c0e] px-3 sm:px-5" aria-label="Main navigation">
        <div className="flex h-full w-full items-center md:grid md:grid-cols-[1fr_auto_1fr]">
          ...
          <details className="group relative ml-auto md:hidden">
            ...
            <div className="absolute right-0 top-12 w-64 rounded-2xl border border-white/10 bg-zinc-950 p-3 shadow-2xl shadow-black/60">
              ...
              <div className="mt-2 border-t border-white/[0.07] pt-3"><a href="/api/github/auth" className="grid h-10 place-items-center rounded-lg bg-zinc-100 text-[13px] font-semibold text-zinc-950">Continue with GitHub</a></div>
            </div>
          </details>
        </div>
      </nav>
